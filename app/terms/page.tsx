      ...
      <main className="pt-32 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[var(--card)] p-8 sm:p-12 rounded-3xl border border-[var(--border)] shadow-2xl space-y-6 text-[var(--muted-foreground)] text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">1. Terms</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">2. Educational Use License</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">3. Medical & Psychological Disclaimer</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">4. Limitations</h2>
            <p>
