    ...
    <>
      ...
      <main className="pt-32 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[var(--card)] p-8 sm:p-12 rounded-3xl border border-[var(--border)] shadow-2xl space-y-6 text-[var(--muted-foreground)] text-sm leading-relaxed">
          ...
          <p className="text-xs text-[var(--muted-foreground)]">Last updated: July 22, 2026</p>

          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">1. Introduction</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">2. Log Files & Analytics</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">3. Cookies and Web Beacons</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">4. Google DoubleClick DART Cookie & AdSense</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1 text-[var(--muted-foreground)]">
              ...
              <li>Users may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-[var(--primary)] hover:underline">Google Ads Settings</a>.</li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">5. Third Party Privacy Policies</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--foreground)]">6. GDPR & CCPA Rights</h2>
            <p>
          ...
          <section className="space-y-3 pt-4 border-t border-[var(--border)]">
            <h2 className="text-lg font-bold text-[var(--foreground)]">7. Contact Information</h2>
            <p>
              If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us at <strong className="text-[var(--primary)]">shaswatraj3@gmail.com</strong>.
            </p>
          </section>
        </div>
      </main>
